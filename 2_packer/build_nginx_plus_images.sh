...
cat certs/kuberneteslab0001.axwaydemo.net.crt.pem certs/kuberneteslab0001.axwaydemo.net.issuer.pem >certs/kuberneteslab0001.axwaydemo.net.fullchain.pem
...
sudo docker run -d   --restart=always   --name registryY   -v "$(pwd)"/certs:/certs   -e REGISTRY_HTTP_ADDR=0.0.0.0:443 -e REGISTRY_HTTP_TLS_CERTIFICATE=certs/kuberneteslab0001.axwaydemo.net.fullchain.pem   -e REGISTRY_HTTP_TLS_KEY=certs/kuberneteslab0001.axwaydemo.net.key.pem  -p 443:443  registry:2
...
#sudo sh -c 'echo "127.0.0.1 dockerregistry.kuberneteslab0001.axwaydemo.net">>/etc/hosts'

sudo docker tag $NPLUS_IMAGE dockerregistry.kuberneteslab0001.axwaydemo.net/nginxplus
sudo docker push dockerregistry.kuberneteslab0001.axwaydemo.net/nginxplus
