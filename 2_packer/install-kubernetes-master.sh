...
#export NOIP_USERNAME=kuberneteslab0001
...
# We also need to create the default TLS secret for the ingress controller. We use our *.kuberneteslab0001.axwaydemo.net cert/key pair here.
...
kubectl create secret tls default-server-secret --key=certs/kuberneteslab0001.axwaydemo.net.key.pem --cert=certs/kuberneteslab0001.axwaydemo.net.fullchain.pem
