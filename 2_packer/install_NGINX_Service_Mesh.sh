...
./nginx-meshctl deploy --nginx-mesh-api-image="dockerregistry.kuberneteslab0001.axwaydemo.net:443/nginx-mesh-api:0.6.0" --nginx-mesh-metrics-image="dockerregistry.kuberneteslab0001.axwaydemo.net:443/nginx-mesh-metrics:0.6.0" --nginx-mesh-sidecar-image="dockerregistry.kuberneteslab0001.axwaydemo.net:443/nginx-mesh-sidecar:0.6.0" --nginx-mesh-init-image="dockerregistry.kuberneteslab0001.axwaydemo.net:443/nginx-mesh-init:0.6.0"
