resource "aws_instance" "kuberneteslab0001-docker-registry" {
  ...
  tags = {
    Name = "kuberneteslab0001-docker-registry"
  }
}
...
resource "null_resource" "buildimages" {
  triggers = {
    first_trigger  = aws_route53_record.dockerregistry-kuberneteslab0001.ttl
	second_trigger = aws_instance.kuberneteslab0001-docker-registry.public_ip
  }
  ...
  provisioner "remote-exec" {
    ...
    host     = aws_instance.kuberneteslab0001-docker-registry.public_ip
  }
